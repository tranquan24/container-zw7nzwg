...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-zw7nzwg.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-zw7nzwg.containers.anotherwebservice.com/
...
```
git clone git@github.com:tranquan24/container-zw7nzwg.git
cd container-zw7nzwg
```
...
```
docker attach container-zw7nzwg
```
